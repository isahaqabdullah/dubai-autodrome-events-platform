import type { EventAnalyticsSummary, EventRecord, RecentScanActivity } from "@/lib/types";
...
export const demoEvents: EventRecord[] = [
  {
    ...
    form_config: {
      ...
      introNote: "This local preview is using demo data because no live Supabase environment is configured yet.",
      successMessage: "Demo mode: verification is simulated locally.",
  ...
  },
  {
    ...
    form_config: {
      ...
      introNote: "This edition shows how a future occurrence is created from configuration only.",
      successMessage: "Demo mode: verification is simulated locally.",
      showCompanyField: true,
      showEmergencyFields: true
    },
