      ...
      <main className="page-shell">
        <div className="card-panel mx-auto max-w-2xl px-4 py-8 text-center sm:px-6 sm:py-12">
          ...
          <div className="mt-6 flex flex-wrap justify-center gap-2 sm:mt-8 sm:gap-3">
            <Link
              href="/events"
              className="inline-flex rounded-xl bg-ink px-4 py-2.5 text-sm font-semibold text-white sm:rounded-2xl"
            >
              Browse events
            </Link>
            {result.eventId ? (
              <Link
                href="/events"
                className="inline-flex rounded-xl border border-slate/20 bg-white px-4 py-2.5 text-sm font-semibold text-ink sm:rounded-2xl"
              >
                Back to public site
              </Link>
            ) : null}
